...
doubleEveryOther = reverse . doubleOtherForward . reverse -- reverse,reverse?
...
-- Example: validate 4012888888881881 = 90 = True
-- Example: validate 4012888888881882 = 91 = False
validate :: Integer -> Bool
-- validate x = (x `mod` 10) == 0
validate = (== 0) . flip mod 10
